var roteiro = {
    cenas: [
        ...
        },
        {
            cena: {
                ...
                acoes: [
                    ...
                    {
                        id: 3,
                        texto: 'Perguntar novamente oque está acontecendo.',
                        idProximaCena: 0
                    }
                ]
            }
        ...
        },
        {
            cena: {
                id: 5,
                texto: 'Handsome sai de sua cela e corre na direção da saida ao final do corredor e abre as celas no entanto apenas Roger e o outro infeliz da cela do Handsome estvam presos ali. \n' +
